            ...
            <form className="flex items-center justify-center w-full max-w-md">
                ...
                <div className="relative w-full">
                    ...
                    <input
                        type="text"
                        id="simple-search"
                        className="opacity-100 border-8 outline-none border-amber-500 text-white text-sm rounded-full focus:ring-gray-500 focus:border-white block w-full pl-10 p-2.5 placeholder:text-white"
                        placeholder="Search..."
                        required
                    />
                </div>
